...
const I18N = {
  es: {
    ...
    catalog_no_sellables:'Todavía no hay nada para mostrar — agregá productos (con foto y precio de venta quedan mejor).',
  ...
  en: {
    ...
    catalog_no_sellables:'Nothing to show yet — add products (photo and sale price make them look best).',
