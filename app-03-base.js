...
const I18N = {
  es: {
    ...
    svc_job_profit:'Ganancia de este trabajo', svc_job_cogs_note:'Incluye {amount} de mercadería que salió con el trabajo.', svc_collect_label:'Cobro', svc_paid:'Cobrado', svc_pending_days:'Pendiente · {n} días',
    ...
    activity_job_saved:'guardó el trabajo de', activity_job_paid:'cobró a', activity_job_deleted:'eliminó el trabajo de',
  ...
  en: {
    ...
    svc_job_profit:'Profit on this job', svc_job_cogs_note:'Includes {amount} of goods that went out with the job.', svc_collect_label:'Payment', svc_paid:'Paid', svc_pending_days:'Pending · {n} days',
    ...
    outflow_service:'Job',
    activity_job_saved:'saved the job for', activity_job_paid:'collected from', activity_job_deleted:'deleted the job for',
