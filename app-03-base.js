...
const I18N = {
  es: {
    ...
    stock_of:'de',
    stock_suggested_order:'Pedido sugerido:',
    ...
    sync_loading_title:'Cargando tu inventario…',
    ...
    /* AVISO DE BORRADO: que se pierde, con nombre y apellido (auditoria
       2026-09-11). "No se puede deshacer" no dice NADA util: el usuario ya
       sabe que borrar borra. Lo que no sabe es que tambien se va la foto que
       le costo sacar, el precio de venta y los nombres que el escaner
       aprendio de sus recibos. La lista se arma con lo que ESE producto tiene
       de verdad (ver textoLoQueSePierde), nunca generica. */
    del_lose_title:'¿Eliminar "{name}" del inventario?',
    del_lose_intro:'Se va a perder:',
    del_lose_photo:'• la foto',
    del_lose_price:'• el precio de venta ({v})',
    del_lose_sku:'• el código ({v})',
    del_lose_supplier:'• el proveedor ({v})',
    del_lose_alias:'• {n} nombre(s) que el escáner aprendió de tus recibos',
    del_lose_stock:'• {v} en stock, valorado en {m}',
    del_lose_keeps:'El historial de compras y los recibos NO se tocan: lo que ya gastaste sigue contando.',
    ...
    activity_you:'Tú',
    inv_select_btn:'Elegir', inv_select_done:'Listo',
    ...
    inv_order_selected:'Pedir ({n})',
    order_share_title:'Lo que necesito pedir',
    order_no_supplier:'Sin proveedor cargado',
    order_nothing:'De lo marcado no falta nada por pedir.',
    order_copied:'Pedido copiado — pégalo donde lo pidas.',
    suggested_order_share:'Compartir el pedido',
    inv_move_to_prod:'A producción ({n})',
    inv_move_to_prod_skip:'{f} de los marcados no pueden ser insumo (gastos o piezas ya hechas) y no van a entrar.',
    ...
    ideas_field_title:'En una línea', ideas_field_body:'Cuéntanos más (opcional)',
    ideas_ph_title_idea:'Ej. Que el escáner lea recibos de varias páginas', ideas_ph_title_bug:'Ej. Al girar el teléfono se cierra el modal',
    ideas_ph_body_idea:'¿Qué harías con eso? ¿Cómo lo resuelves hoy?', ideas_ph_body_bug:'¿Qué hiciste, qué esperabas y qué pasó?',
    ideas_public_note:'Se publica con tu nombre. Nunca mostramos tu correo.',
    ideas_publish:'Publicar', ideas_posted:'¡Publicado! Gracias por ayudar a mejorar Dusty.',
    ideas_err_title:'Escribe al menos unas palabras en la primera línea.',
    ideas_err_cooldown:'Espera un minuto antes de publicar otra.',
    ideas_err_send:'No se pudo guardar — revisa tu conexión y prueba de nuevo.',
    ideas_signin_note:'Para proponer y votar necesitas una cuenta con tu nombre.', ideas_signin_btn:'Iniciar sesión',
    ideas_loading:'Cargando ideas…', ideas_error:'No se pudo cargar el tablero.', ideas_retry:'Reintentar',
    ideas_empty:'Todavía no hay ideas. ¡Sé la primera persona en proponer una!',
    ideas_empty_filter:'Nada con ese filtro por ahora.',
    ideas_sort_aria:'Ordenar', ideas_sort_top:'Más votadas', ideas_sort_new:'Recientes',
    ideas_f_all:'Todas', ideas_st_new:'Recibida', ideas_st_planned:'En camino', ideas_st_done:'Lista', ideas_st_declined:'No por ahora',
    ideas_vote_aria:'Votar', ideas_by:'por {name}', ideas_delete:'Borrar',
    ideas_delete_confirm:'¿Borrar esta idea? No se puede deshacer.',
    ideas_reply_from:'Respuesta de Dusty', ideas_reply_btn:'Responder', ideas_reply_edit:'Editar respuesta',
    ideas_reply_ph:'Qué vamos a hacer con esto, o por qué no por ahora…', ideas_reply_save:'Guardar respuesta',
    ideas_foot:'Cada idea que llega a "Lista" salió de alguien que la propuso aquí.',
    ...
    /* Introducción v2 (2026-09-11): titular corto para todos, dos gestos (cámara
       e IA) y baldosas según lo que marcó en "¿Qué hace tu negocio?". */
    ob_head:'Bienvenido a {logo}, tu negocio se lleva <em>solo</em>.',
    ob_cam_title:'Escanea el recibo', ob_cam_sub_stock:'Una foto y el stock se actualiza al toque.', ob_cam_sub_job:'Una foto y el gasto queda en el trabajo que elijas.',
    ob_ai_title:'Díselo a Dusty', ob_ai_sub:'Por voz o texto: «{ej}»',
    ob_ai_ex_sells:'Gasté 500 en combustible', ob_ai_ex_makes:'Produje 20 tortas hoy', ob_ai_ex_services:'Cobré el trabajo de Pérez',
    ob_t_crit:'Críticos', ob_t_crit_sub:'Qué se está acabando', ob_t_order:'Pedido sugerido', ob_t_order_sub:'Qué reponer esta semana',
    ob_t_prod:'Producción', ob_t_prod_sub:'Recetas y salidas', ob_t_raw:'Materia prima', ob_t_raw_sub:'Lo que gastas al producir',
    ob_t_jobs:'Trabajos', ob_t_jobs_sub:'Agenda y ganancia', ob_t_collect:'Por cobrar', ob_t_collect_sub:'Quién te debe',
    ob_t_team:'Equipo', ob_t_team_sub:'Comparte con tu empleado', ob_t_recap:'Cierre de mes', ob_t_recap_sub:'Tu mes en una página',
    ob_biz_hint:'Dusty se arma según esto.',
    ob_cta:'Empezar',
    ...
    rd_scanned_on:'escaneado el', rd_applied_to:'aplicado a:',
    ...
    scan_lines_skipped:'{n} línea(s) quedaron fuera: sin cantidad o sin precio',
    ...
    btn_add_product_manually:'+ Agregar producto a mano',
    ...
    produce_short_confirm:'No alcanza el stock registrado de {n} insumo(s): {list}.\n\nSe descuenta todo lo que haya y el faltante queda anotado en la salida. ¿Producir igual?',
    ...
    /* Reports: el informe del mes en PDF (app-14). El botón se llama "Reports"
    ...
    rb_no_lines:'Sin líneas extraídas',
    ...
    rp_by_category:'Gastos por categoría', rp_detail:'Detalle de recibos y gastos', rp_by_product:'Compras por producto',
    rp_col_concept:'Concepto', rp_col_amount:'Monto', rp_col_category:'Categoría', rp_col_cap:'Tope',
    rp_col_date:'Fecha', rp_col_who:'Proveedor / descripción', rp_col_kind:'Tipo', rp_col_total:'Total',
    rp_col_product:'Producto', rp_col_qty:'Cantidad',
    rp_kind_expense:'Gasto', rp_kind_goods:'Mercadería', rp_kind_mixed:'Mixto',
    rp_total:'Total', rp_none:'Nada registrado en este período.', rp_page:'Página {n} de {t}',
    rp_downloaded:'Informe descargado.', rp_failed:'No se pudo generar el informe — intenta de nuevo.',
    rp_share_failed:'No se pudo compartir el PDF — intenta de nuevo.',
    ...
    oc_card_label:'Calculadora de pedido',
    ...
    ivd_value_title:'Valor del inventario', ivd_value_how:'Cantidad en stock × costo unitario de cada producto. Es lo que tenés invertido en mercadería ahora mismo.',
    ivd_potential_title:'Potencial de venta', ivd_potential_how:'Cantidad en stock × precio de venta de los productos que tienen precio. Es lo que ingresaría si vendieras todo.',
    ivd_by_category:'Por categoría', ivd_by_product:'Por producto', ivd_products_n:'{n} productos', ivd_products_1:'1 producto', ivd_tap_hint:'Tocá un producto para editarlo.',
    ivd_profit:'Ganancia potencial', ivd_cost_of:'Costo de esa mercadería', ivd_margin:'margen', ivd_no_price:'Sin precio de venta · no suman', ivd_set_price:'Ponerle precio',
    ivd_empty:'No hay productos con stock todavía.', ivd_see_detail:'Ver detalle',
    ...
    /* Despedida (openGoodbye, app-06): después de que la cuenta se eliminó. */
    gb_kicker:'Hasta pronto', gb_title:'Gracias por usar Dusty',
    gb_sub:'Tu cuenta, inventario, recibos y fotos se eliminaron por completo — ni en tu teléfono ni en la nube.',
    gb_done:'Todo eliminado',
    gb_offer_head:'¿Por qué te vas? Cuéntanos y <b>tu próximo mes va por nuestra cuenta</b> hasta que lo reparemos.',
    gb_offer_sub:'Leemos cada respuesta. Si vuelves con el mismo email, el mes gratis ya está guardado.',
    gb_r_use:'No la uso lo suficiente', gb_r_scan:'El escáner lee mal', gb_r_missing:'Me falta una función', gb_r_hard:'Es complicada', gb_r_price:'El precio', gb_r_other:'Otra razón',
    gb_ph:'Cuéntanos más (opcional)…', gb_send:'Enviar y guardar mi mes gratis', gb_sending:'Enviando…', gb_send_failed:'No se pudo enviar — revisa tu conexión e intenta de nuevo.',
    gb_thanks:'¡Gracias! Tu mes gratis queda guardado para {email}. Cuando vuelvas, entra con ese email y lo tienes.',
    gb_again:'Empezar de nuevo', gb_close:'Cerrar Dusty',
    gb_closed_title:'Ya puedes cerrar esta pestaña', gb_closed_sub:'Que te vaya muy bien.',
    ...
    inv_layout_label:'Vista del inventario', ivd_layout_list:'Lista',
    ...
    inv_search_ph:'Buscar {n} productos', inv_more:'ver los {n} restantes', inv_less:'ver menos',
    inv_group_toggle_aria:'Plegar o desplegar la categoría',
    dash_today:'Hoy', dash_tool_products:'Productos', dash_tool_manual:'A mano',
    dash_stat_crit:'Críticos', dash_stat_count:'Toca contar',
    ...
    prod_search_ph:'Buscar', prod_no_sale_price:'Sin precio de venta',
    ...
    agent_quota_left:'Te quedan {n} pedidos al asistente este mes.', agent_quota_last:'Te queda 1 pedido al asistente este mes.',
    agent_quota_trial:'Te quedan {n} pedidos de prueba.', agent_quota_trial_last:'Te queda 1 pedido de prueba.',
    ...
    svc_xcats_sub:'Tocá un nombre para cambiarlo. Borrá las que no uses: sus recibos quedan como Sin categoría.', svc_xcat_add:'+ Categoría', svc_xcats_empty:'Sin categorías todavía.', svc_xcat_new_name:'Nueva categoría', svc_xcat_del_confirm:'¿Borrar «{name}»? {n} recibo(s) quedan sin categoría.',
    svc_set_odo:'Odómetro', svc_set_odo_sub:'Apagalo si tu equipo no lleva kilómetros (limpieza, herramientas, oficina): desaparece todo lo de km.',
    ...
    ob_biz_sells:'Vende productos', ob_biz_sells_sub:'Lleva stock, escanea recibos, evita quedarte sin nada',
    ob_biz_makes:'Fabrica', ob_biz_makes_sub:'Recetas, producción y salidas desde la materia prima',
    ob_biz_services:'Presta servicios', ob_biz_services_sub:'Trabajos, cobros, equipo y mantenimientos',
    ob_biz_continue:'Continuar',
    settings_biz_title:'Tu negocio', settings_services_title:'Servicios',
    biz_sells:'Vende productos', biz_sells_sub:'Inventario, stock crítico, conteo, pedido sugerido',
    biz_makes:'Fabrica', biz_makes_sub:'Recetas, producción y salidas',
    biz_services:'Presta servicios', biz_services_sub:'Trabajos, cobros, equipo y mantenimientos',
    svc_set_remind:'Recordar cobros vencidos', svc_set_remind_sub:'Tarjeta en el Dashboard cuando un cobro pasó su fecha',
    svc_set_maint_days:'Aviso de mantenimiento', svc_days_before:'{n} días antes',
    svc_set_categories:'Categorías de gasto', svc_set_catalog:'Mis servicios y precios',
    svc_tool_job:'Trabajo', svc_tool_spend:'Gasto', svc_tool_asset:'Activo', svc_tool_maint:'Mantenimiento',
    svc_tile_jobs:'Trabajos', svc_badge_today:'Hoy', svc_jobs_none_today:'Ninguno hoy · tocá para agregar',
    svc_tile_collect:'Por cobrar', svc_collect_sub:'{c} clientes · {o} vencido', svc_collect_none:'Nada pendiente',
    svc_tile_maint:'Mantenimiento', svc_maint_all_ok:'Todo al día',
    svc_title_equipo:'Equipo y activos', svc_tile_equipo_sub:'{n} activos',
    svc_overdue_card_title:'Cobros vencidos: {n}', svc_overdue_card_sub:'{amount} pasados de fecha · tocá para recordar',
    svc_tag_ok:'Al día', svc_tag_maint:'Mantenimiento', svc_tag_soon:'Pronto', svc_tag_overdue:'Vencido', svc_tag_pending:'Pendiente', svc_tag_paid:'Cobrado',
    svc_stat_assets:'Activos', svc_stat_value:'Valor', svc_stat_month_spend:'Gasto mes', svc_spend_month_short:'gasto mes',
    ...
    svc_jobs_month_n:'{n} trabajos este mes', svc_expenses_month:'Gastos del mes', svc_leaves_month:'Deja este mes',
    ...
    svc_billed_with:'Facturado con este activo', svc_paid_of_short:'cobrado {amount}', svc_since_purchase:'Desde siempre', svc_since_purchase_sub:'{jobs} · facturado {billed} · gastos {spent}',
    ...
    svc_unit_days_short:'días', svc_jobs_n:'{n} trabajos', svc_job_1:'1 trabajo', svc_job_month_1:'1 trabajo este mes', svc_expenses_of:'Gastos de {m}', svc_net_of:'Resultado de {m}',
    ...
    svc_asset_used:'Equipo usado', svc_asset_none:'Ninguno', svc_price:'Precio',
    svc_job_expenses:'Gastos del trabajo', svc_job_expenses_none:'Todavía sin gastos', svc_scan_receipt_btn:'📷 Escanear recibo', svc_spend_by_hand:'+ Gasto a mano',
    svc_exp_desc:'Descripción', svc_exp_amount:'Monto', svc_exp_add:'Agregar', svc_expenses_short:'gastos',
    svc_job_profit:'Ganancia de este trabajo', svc_job_gone:'Este trabajo ya no existe (se eliminó desde otro teléfono).', svc_job_cogs_note:'Incluye {amount} de mercadería que salió con el trabajo.', svc_collect_label:'Cobro', svc_paid:'Cobrado', svc_pending_days:'Pendiente · {n} días',
    ...
    svc_due_in:'vence en {n} días', svc_due_ago:'vence hace {n} días', svc_due_today:'vence hoy',
    svc_whatsapp:'💬 Recordar por WhatsApp', svc_mark_paid:'✓ Cobrado', svc_marked_paid:'Cobrado ✓',
    svc_paid_week:'Cobrado esta semana', svc_paid_on:'cobrado {when}', svc_paid_yesterday:'cobrado ayer', svc_paid_today:'cobrado hoy',
    svc_collect_empty:'Nada por cobrar. 🎉',
    svc_collect_warn:'{n} cobros pendientes acumulados. Nunca se borran solos — marca como cobrados o elimina los que ya no vas a cobrar, para que la app siga guardando rápido.',
    ...
    recap_revenue_jobs:'Ingresos por trabajos', recap_est_note_svc:'Ingresos según los trabajos que cargaste (cobrados o pendientes) menos los gastos de tus recibos.', recap_jobs_n:'{jobs} en el período', recap_by_asset:'Por activo', recap_bycat:'Gastos por categoría',
    outflow_service:'Trabajo',
    activity_job_saved:'guardó el trabajo de', activity_receipt_added:'registró el gasto', activity_job_paid:'cobró a', activity_job_deleted:'eliminó el trabajo de',
    activity_asset_saved:'guardó el activo', activity_maint_logged:'registró mantenimiento de',
    ...
    outflow_production:'Producción', outflow_adjust:'Ajuste de estante', outflow_count:'Conteo cíclico',
  ...
  en: {
    ...
    stock_of:'of',
    stock_suggested_order:'Suggested order:',
    ...
    sync_loading_title:'Loading your inventory…',
    ...
    del_lose_title:'Delete "{name}" from inventory?',
    del_lose_intro:'You will lose:',
    del_lose_photo:'• the photo',
    del_lose_price:'• the sale price ({v})',
    del_lose_sku:'• the SKU ({v})',
    del_lose_supplier:'• the supplier ({v})',
    del_lose_alias:'• {n} name(s) the scanner learned from your receipts',
    del_lose_stock:'• {v} in stock, worth {m}',
    del_lose_keeps:'Purchase history and receipts are NOT touched: what you already spent still counts.',
    ...
    inv_order_selected:'Order ({n})',
    order_share_title:'What I need to order',
    order_no_supplier:'No supplier set',
    order_nothing:'Nothing to order from what you selected.',
    order_copied:'Order copied — paste it wherever you order.',
    suggested_order_share:'Share the order',
    inv_move_to_prod:'To production ({n})',
    inv_move_to_prod_skip:'{f} of the selected cannot be inputs (expenses or finished pieces) and will be left out.',
    ...
    ideas_field_title:'In one line', ideas_field_body:'Tell us more (optional)',
    ideas_ph_title_idea:'E.g. Let the scanner read multi-page receipts', ideas_ph_title_bug:'E.g. Rotating the phone closes the dialog',
    ideas_ph_body_idea:'What would you do with it? How do you handle it today?', ideas_ph_body_bug:'What did you do, what did you expect, what happened?',
    ideas_public_note:'Posted under your name. We never show your email.',
    ideas_publish:'Post', ideas_posted:'Posted! Thanks for helping make Dusty better.',
    ideas_err_title:'Write at least a few words in the first line.',
    ideas_err_cooldown:'Wait a minute before posting another one.',
    ideas_err_send:"Couldn't save it — check your connection and try again.",
    ideas_signin_note:'To suggest and vote you need an account with your name.', ideas_signin_btn:'Sign in',
    ideas_loading:'Loading ideas…', ideas_error:"Couldn't load the board.", ideas_retry:'Retry',
    ideas_empty:'No ideas yet. Be the first to suggest one!',
    ideas_empty_filter:'Nothing under that filter for now.',
    ideas_sort_aria:'Sort', ideas_sort_top:'Top voted', ideas_sort_new:'Newest',
    ideas_f_all:'All', ideas_st_new:'Received', ideas_st_planned:'On the way', ideas_st_done:'Done', ideas_st_declined:'Not for now',
    ideas_vote_aria:'Vote', ideas_by:'by {name}', ideas_delete:'Delete',
    ideas_delete_confirm:"Delete this idea? This can't be undone.",
    ideas_reply_from:'Reply from Dusty', ideas_reply_btn:'Reply', ideas_reply_edit:'Edit reply',
    ideas_reply_ph:"What we'll do about it, or why not for now…", ideas_reply_save:'Save reply',
    ideas_foot:'Every idea that reaches "Done" started with someone suggesting it here.',
    ...
    ob_cam_title:'Scan the receipt', ob_cam_sub_stock:'One photo and your stock updates instantly.', ob_cam_sub_job:'One photo and the expense lands on the job you pick.',
    ob_ai_title:'Just tell Dusty', ob_ai_sub:'By voice or text: “{ej}”',
    ob_ai_ex_sells:'Spent 500 on fuel', ob_ai_ex_makes:'Made 20 cakes today', ob_ai_ex_services:'Got paid for the Perez job',
    ob_t_crit:'Critical', ob_t_crit_sub:'What is running out', ob_t_order:'Suggested order', ob_t_order_sub:'What to restock this week',
    ob_t_prod:'Production', ob_t_prod_sub:'Recipes and outflows', ob_t_raw:'Raw materials', ob_t_raw_sub:'What you spend to produce',
    ob_t_jobs:'Jobs', ob_t_jobs_sub:'Schedule and profit', ob_t_collect:'To collect', ob_t_collect_sub:'Who owes you',
    ob_t_team:'Team', ob_t_team_sub:'Share with your staff', ob_t_recap:'Month recap', ob_t_recap_sub:'Your month on one page',
    ob_biz_hint:'Dusty sets itself up from this.',
    ob_cta:'Get started',
    ...
    rd_scanned_on:'scanned on', rd_applied_to:'applied to:',
    ...
    scan_lines_skipped:'{n} line(s) left out: no quantity or no price',
    ...
    btn_add_product_manually:'+ Add product by hand',
    ...
    produce_short_confirm:'Recorded stock falls short on {n} supply(ies): {list}.\n\nWhatever is there gets deducted and the shortfall is recorded on the outflow. Produce anyway?',
    ...
    rb_no_lines:'No extracted lines',
    ...
    rp_by_category:'Expenses by category', rp_detail:'Receipts and expenses', rp_by_product:'Purchases by product',
    rp_col_concept:'Item', rp_col_amount:'Amount', rp_col_category:'Category', rp_col_cap:'Cap',
    rp_col_date:'Date', rp_col_who:'Supplier / description', rp_col_kind:'Type', rp_col_total:'Total',
    rp_col_product:'Product', rp_col_qty:'Quantity',
    rp_kind_expense:'Expense', rp_kind_goods:'Goods', rp_kind_mixed:'Mixed',
    rp_total:'Total', rp_none:'Nothing recorded in this period.', rp_page:'Page {n} of {t}',
    rp_downloaded:'Report downloaded.', rp_failed:'Couldn’t generate the report — try again.',
    rp_share_failed:'Couldn’t share the PDF — try again.',
    ...
    oc_card_label:'Order calculator',
    ...
    ivd_value_title:'Inventory value', ivd_value_how:'Quantity in stock × unit cost of each product. It is what you have invested in goods right now.',
    ivd_potential_title:'Sale potential', ivd_potential_how:'Quantity in stock × sale price of the products that have a price. It is what would come in if you sold everything.',
    ivd_by_category:'By category', ivd_by_product:'By product', ivd_products_n:'{n} products', ivd_products_1:'1 product', ivd_tap_hint:'Tap a product to edit it.',
    ivd_profit:'Potential profit', ivd_cost_of:'Cost of those goods', ivd_margin:'margin', ivd_no_price:'No sale price · not counted', ivd_set_price:'Set a price',
    ivd_empty:'No products in stock yet.', ivd_see_detail:'See detail',
    ...
    gb_kicker:'See you soon', gb_title:'Thanks for using Dusty',
    gb_sub:'Your account, inventory, receipts and photos are completely deleted — nothing left on your phone or in the cloud.',
    gb_done:'Everything deleted',
    gb_offer_head:'Why are you leaving? Tell us and <b>your next month is on us</b> until we fix it.',
    gb_offer_sub:'We read every answer. Come back with the same email and the free month is already waiting.',
    gb_r_use:'I don’t use it enough', gb_r_scan:'The scanner misreads', gb_r_missing:'Missing a feature', gb_r_hard:'Too complicated', gb_r_price:'The price', gb_r_other:'Something else',
    gb_ph:'Tell us more (optional)…', gb_send:'Send and save my free month', gb_sending:'Sending…', gb_send_failed:'Couldn’t send — check your connection and try again.',
    gb_thanks:'Thanks! Your free month is saved for {email}. Come back with that email and it’s yours.',
    gb_again:'Start over', gb_close:'Close Dusty',
    gb_closed_title:'You can close this tab now', gb_closed_sub:'All the best.',
    ...
    inv_layout_label:'Inventory view', ivd_layout_list:'List',
    ...
    dash_stat_crit:'Critical', dash_stat_count:'To count',
    ...
    prod_search_ph:'Search', prod_no_sale_price:'No sale price',
    ...
    agent_quota_left:'You have {n} assistant requests left this month.', agent_quota_last:'You have 1 assistant request left this month.',
    agent_quota_trial:'You have {n} trial requests left.', agent_quota_trial_last:'You have 1 trial request left.',
    ...
    svc_xcats_sub:'Tap a name to rename it. Delete the ones you don\'t use: their receipts become Uncategorized.', svc_xcat_add:'+ Category', svc_xcats_empty:'No categories yet.', svc_xcat_new_name:'New category', svc_xcat_del_confirm:'Delete “{name}”? {n} receipt(s) become uncategorized.',
    svc_set_odo:'Odometer', svc_set_odo_sub:'Turn it off if your equipment has no mileage (cleaning, tools, office): everything about km goes away.',
    ...
    ob_biz_sells:'Sells products', ob_biz_sells_sub:'Track stock, scan receipts, never run out',
    ob_biz_makes:'Makes products', ob_biz_makes_sub:'Recipes, production and outflows from raw materials',
    ob_biz_services:'Provides services', ob_biz_services_sub:'Jobs, payments, equipment and maintenance',
    ob_biz_continue:'Continue',
    settings_biz_title:'Your business', settings_services_title:'Services',
    biz_sells:'Sells products', biz_sells_sub:'Inventory, critical stock, counts, suggested order',
    biz_makes:'Makes products', biz_makes_sub:'Recipes, production and outflows',
    biz_services:'Provides services', biz_services_sub:'Jobs, payments, equipment and maintenance',
    svc_set_remind:'Remind overdue payments', svc_set_remind_sub:'Dashboard card when a payment is past due',
    svc_set_maint_days:'Maintenance notice', svc_days_before:'{n} days before',
    svc_set_categories:'Expense categories', svc_set_catalog:'My services and prices',
    svc_tool_job:'Job', svc_tool_spend:'Expense', svc_tool_asset:'Asset', svc_tool_maint:'Maintenance',
    svc_tile_jobs:'Jobs', svc_badge_today:'Today', svc_jobs_none_today:'None today · tap to add',
    svc_tile_collect:'To collect', svc_collect_sub:'{c} clients · {o} overdue', svc_collect_none:'Nothing pending',
    svc_tile_maint:'Maintenance', svc_maint_all_ok:'All up to date',
    svc_title_equipo:'Equipment & assets', svc_tile_equipo_sub:'{n} assets',
    svc_overdue_card_title:'Overdue payments: {n}', svc_overdue_card_sub:'{amount} past due · tap to remind',
    svc_tag_ok:'Up to date', svc_tag_maint:'Maintenance', svc_tag_soon:'Soon', svc_tag_overdue:'Overdue', svc_tag_pending:'Pending', svc_tag_paid:'Paid',
    svc_stat_assets:'Assets', svc_stat_value:'Value', svc_stat_month_spend:'Month spend', svc_spend_month_short:'month spend',
    ...
    svc_jobs_month_n:'{n} jobs this month', svc_expenses_month:'This month\'s expenses', svc_leaves_month:'Leaves this month',
    ...
    svc_billed_with:'Billed with this asset', svc_paid_of_short:'paid {amount}', svc_since_purchase:'All time', svc_since_purchase_sub:'{jobs} · billed {billed} · spent {spent}',
    ...
    svc_unit_days_short:'days', svc_jobs_n:'{n} jobs', svc_job_1:'1 job', svc_job_month_1:'1 job this month', svc_expenses_of:'Expenses in {m}', svc_net_of:'Net for {m}',
    ...
    svc_asset_used:'Equipment used', svc_asset_none:'None', svc_price:'Price',
    svc_job_expenses:'Job expenses', svc_job_expenses_none:'No expenses yet', svc_scan_receipt_btn:'📷 Scan receipt', svc_spend_by_hand:'+ Expense by hand',
    svc_exp_desc:'Description', svc_exp_amount:'Amount', svc_exp_add:'Add', svc_expenses_short:'expenses',
    svc_job_profit:'Profit on this job', svc_job_gone:'This job no longer exists (it was deleted from another phone).', svc_job_cogs_note:'Includes {amount} of goods that went out with the job.', svc_collect_label:'Payment', svc_paid:'Paid', svc_pending_days:'Pending · {n} days',
    ...
    svc_due_in:'due in {n} days', svc_due_ago:'due {n} days ago', svc_due_today:'due today',
    svc_whatsapp:'💬 Remind on WhatsApp', svc_mark_paid:'✓ Paid', svc_marked_paid:'Paid ✓',
    svc_paid_week:'Paid this week', svc_paid_on:'paid {when}', svc_paid_yesterday:'paid yesterday', svc_paid_today:'paid today',
    svc_collect_empty:'Nothing to collect. 🎉',
    svc_collect_warn:'{n} pending payments piled up. They never get cleared out on their own — mark the ones you\'ve collected as paid, or delete the ones you won\'t, so the app keeps saving fast.',
    ...
    recap_revenue_jobs:'Income from jobs', recap_est_note_svc:'Income from the jobs you logged (paid or pending) minus the expenses on your receipts.', recap_jobs_n:'{jobs} in the period', recap_by_asset:'By asset', recap_bycat:'Expenses by category',
    outflow_service:'Job',
    activity_job_saved:'saved the job for', activity_receipt_added:'logged the expense', activity_job_paid:'collected from', activity_job_deleted:'deleted the job for',
    activity_asset_saved:'saved the asset', activity_maint_logged:'logged maintenance for',
    ...
    outflow_production:'Production', outflow_adjust:'Shelf adjustment', outflow_count:'Cycle count',
...
function saveState(){
  ...
  if(typeof dedupeFinishedItems==='function') try{ dedupeFinishedItems(); }catch(e){ console.error('[Dusty] dedupe de terminados:', e); }
  if(stateLoadFailed){
...
function applyStateData(data){
  ...
  // El archivo va ANTES que las salidas (auditoría de datos 2026-09-12): lo que
  // capOutflows recorte acá se archiva contra el outflowArchive YA cargado — si
  // se aplicara después, el archivo del snapshot pisaría lo recién consolidado.
  ...
  // abierto —trabajos sin cobrar, contratos, cotizaciones— nunca se recorta; lo
...
function outflowPL(o){
  if(!o) return null;
  /* TRABAJO de servicios (app-15): el ingreso es lo que se cobra por el trabajo;
     sus gastos son recibos y ya entran como gasto operativo. Sin costo de
     mercadería. Un trabajo borrado (borrado suave) no aporta nada. */
  if(o.type==='service'){
