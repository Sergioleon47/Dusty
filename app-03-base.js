...
const I18N = {
  es: {
    ...
    catalog_dash_btn:'Catálogo para clientes',
    activity_catalog_published:'publicó el catálogo ({n} productos)',
    catalog_title:'Catálogo para clientes',
    catalog_sub:'Elegí qué productos mostrar y compartí el link — tus clientes ven fotos y precios, y te piden por WhatsApp.',
    catalog_wa_label:'WhatsApp para recibir pedidos',
    catalog_wa_helper:'Con código de país (ej. 5215512345678). El botón "Pedir" del catálogo le abre WhatsApp a tu cliente con el pedido escrito.',
    catalog_pick_hint:'Marcá qué mostrar. El precio es el precio de venta de cada producto; sin precio, el catálogo dice "Consultar".',
    catalog_products_header:'Productos',
    ...
    catalog_no_price_tag:'sin precio',
    ...
    catalog_link_label:'Link para compartir',
  ...
  en: {
    ...
    catalog_dash_btn:'Customer catalog',
    activity_catalog_published:'published the catalog ({n} products)',
    catalog_title:'Customer catalog',
    catalog_sub:'Pick what to show and share the link — your customers see photos and prices, and order via WhatsApp.',
    catalog_wa_label:'WhatsApp for orders',
    catalog_wa_helper:'With country code (e.g. 15551234567). The catalog\'s "Order" button opens WhatsApp with the order pre-written.',
    catalog_pick_hint:'Check what to show. The price shown is each product\'s sale price; without one, the catalog says "Ask".',
    catalog_products_header:'Products',
