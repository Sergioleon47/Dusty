...
const I18N = {
  es: {
    ...
    dash_team_title:'Equipo', dash_team_sub:'Compartí con tu empleado',
    ...
    activity_catalog_published:'publicó el catálogo ({n} productos)',
    catalog_wa_label:'WhatsApp para recibir pedidos',
    catalog_photo_fab_aria:'Sacar foto para un producto',
    catalog_camera_title:'Foto de producto',
    catalog_camera_sub:'Sacá o elegí la foto; después le decís de qué producto es y la podés editar.',
    catalog_publish_header:'Publicación',
    catalog_auto_updated:'Catálogo actualizado',
    settings_catalog_btn:'📖 Publicación del catálogo',
    ...
    catalog_tool_templates:'Plantillas',
    tpl_title:'Plantillas', tpl_sub:'Armá una imagen lista para compartir o imprimir con tus productos.',
    tpl_kind_grid:'Catálogo en grilla', tpl_kind_list:'Lista de precios', tpl_kind_menu:'Menú de restaurante', tpl_kind_offer:'Oferta',
    tpl_kind_cats:'Por categorías', tpl_items_n:'{n} productos', tpl_gallery_hint:'Tocá un diseño para verlo grande con tus productos.',
    tpl_format_post:'Post', tpl_format_story:'Historia', tpl_format_sheet:'Hoja',
    tpl_style_dark:'Oscuro', tpl_style_light:'Claro', tpl_style_warm:'Cálido',
    tpl_scope_catalog:'Los del catálogo', tpl_scope_all:'Todos',
    tpl_page:'Página {i} de {n}', tpl_empty:'No hay productos para la plantilla — marcá algunos en el catálogo o elegí "Todos".',
    tpl_share:'Compartir', tpl_save:'Guardar', tpl_rendering:'Armando la imagen…', tpl_saved:'Imagen guardada', tpl_shared_fallback:'Imagen descargada — compartila desde tu galería',
    tpl_offer_label:'OFERTA', tpl_menu_footer:'Pedidos por WhatsApp', tpl_price_ask:'Consultar',
    catalog_collage_min:'Elegí de 2 a 4 fotos para el collage',
    catalog_collage_pick:'Elegí el diseño',
    catalog_examples_note:'Así se ve tu catálogo. Estos ejemplos desaparecen solos cuando agregues tus productos con la 📷 Cámara.',
    catalog_collage_photos:'fotos',
    catalog_collage_need_n:'Este diseño necesita {n} fotos',
    catalog_tool_camera:'Cámara',
    catalog_select_btn:'Seleccionar',
    catalog_select_done:'Listo',
    catalog_select_hint:'Modo selección: tocá los productos para incluirlos o sacarlos del catálogo.',
    catalog_assign_title:'¿De qué producto es esta foto?',
    catalog_detecting:'Reconociendo el producto…',
    catalog_edit_btn:'Editar',
    catalog_edit_title:'Editar foto',
    catalog_edit_auto:'Auto',
    catalog_edit_rotate:'Girar',
    catalog_edit_zoom:'Zoom',
    catalog_tab_light:'Luz',
    catalog_tab_color:'Color',
    catalog_tab_frame:'Encuadre',
    catalog_edit_temp:'Temperatura',
    catalog_edit_shadows:'Sombras',
    catalog_edit_highlights:'Luces',
    catalog_edit_bright:'Brillo',
    catalog_edit_contrast:'Contraste',
    catalog_edit_sat:'Saturación',
    catalog_edit_sharp:'Nitidez',
    catalog_edit_done:'Listo',
    catalog_edit_drag_hint:'Arrastrá la foto para encuadrarla; el zoom acerca.',
    catalog_rembg_btn:'Quitar fondo',
    catalog_rembg_working:'Quitando el fondo…',
    catalog_rembg_bg:'Fondo:',
    catalog_rembg_revert:'Foto original',
    catalog_rembg_done:'Fondo quitado — elegí el color de fondo',
    catalog_rembg_error:'No se pudo quitar el fondo — probá de nuevo',
    catalog_enhance_btn:'Mejorar IA',
    catalog_enhance_working:'Mejorando con IA…',
    catalog_enhance_done:'Foto mejorada con IA',
    catalog_enhance_error:'No se pudo mejorar la foto — probá de nuevo',
    catalog_stage_btn:'Escenario IA',
    catalog_stage_working:'Generando el escenario…',
    catalog_stage_hint:'Elegí dónde poner tu producto — la IA arma el ambiente con su luz y sombras.',
    catalog_stage_wood:'Mesa de madera',
    catalog_stage_kitchen:'Cocina',
    catalog_stage_studio:'Estudio',
    catalog_stage_shelf:'Estante de tienda',
    catalog_stage_custom_ph:'O describilo vos: "sobre pasto, al atardecer"…',
    catalog_stage_go:'Generar',
    catalog_stage_done:'Escenario generado',
    catalog_stage_error:'No se pudo generar el escenario — probá de nuevo',
    ...
    catalog_filter_retro:'Retro',
    catalog_filter_bw:'B/N',
    catalog_recipes_header:'Piezas / recetas',
    catalog_publish_btn:'Publicar catálogo',
    catalog_update_btn:'Actualizar catálogo',
    catalog_publishing:'Publicando…',
    catalog_published_toast:'Catálogo publicado — compartí el link',
    catalog_copy_btn:'Copiar',
    catalog_share_btn:'Compartir',
    catalog_open_btn:'Ver',
    catalog_copied_toast:'Link copiado',
    catalog_unpublish_btn:'Despublicar',
    catalog_unpublish_confirm:'¿Despublicar el catálogo? El link va a dejar de funcionar hasta que lo publiques de nuevo (mismo link).',
    catalog_unpublished_toast:'Catálogo despublicado — el link ya no funciona',
    catalog_none_selected:'Marcá al menos un producto',
    catalog_error:'No se pudo publicar — revisá tu conexión y probá de nuevo',
    catalog_needs_account_note:'Para publicar tu catálogo necesitás guardar tu cuenta (así el link queda tuyo para siempre).',
    ...
    budget_exp_empty_note:'Así se va a ver: escaneá una boleta (luz, agua, internet) o un consumo Eat out y aparecen acá solos — o agregá uno a mano con el botón.',
    ...
    expense_register_payment_hint:'Crea el gasto del mes ya mismo (mueve el presupuesto). Desmarcalo si después vas a escanear la boleta, para no contarlo dos veces.',
    ...
    expense_pay_no_amount:'Este gasto no tiene monto — abrilo y ponele uno primero.',
    ...
    help_q2:'¿Se guarda sin cuenta?', help_a2:'Sí. Todo queda en este teléfono desde el primer segundo. Cuando quieras verlo en otro dispositivo, tocá Guardar mi cuenta: nombre, email y un PIN, y no se pierde nada.',
    help_q3:'¿Cómo comparto con mi socio?', help_a3:'Desde Compartir cuenta en el tablero: le mandás un link y los dos ven y actualizan el mismo inventario, recibos y presupuesto.',
    help_q4:'¿Y si me equivoco?', help_a4:'Antes de guardar un recibo revisás y corregís cada línea. Y cualquier producto o recibo se edita o se borra tocándolo.',
    ...
    first_steps_title:'Primeros pasos', first_step_lang:'Elegiste tu idioma', first_step_scan:'Escaneá tu primer recibo', first_step_budget:'Fijá un presupuesto mensual',
    first_steps_of:'de',
    ...
    save_account_hint_toast:'Tus datos ya viven en este teléfono. Para verlos en otro, tocá ☁ Guardar arriba.',
    ...
    team_pin_label:'Elegí un PIN (mínimo 8 caracteres)', team_pin_confirm_label:'Repetí el PIN',
    ...
    scan_tap_photo:'Tocá para sacar una foto', scan_upload_gallery_btn:'o subí una desde la galería',
    ...
    err_scan_too_big:'Las fotos pesan demasiado para mandarlas juntas — probá con menos páginas por vez.',
    err_scan_timeout:'El lector tardó demasiado con este recibo — probá de nuevo; si es muy largo, escanealo en menos páginas por vez.',
    ...
    produce_no_price_note:'Sin precio de venta, esta producción no suma Ingresos en el Cierre de mes — podés escribirlo acá solo por esta vez.',
    ...
    shelf_price_empty_note:'Sin precio de venta, esta salida no suma Ingresos en el Cierre de mes.',
    ...
    oc_card_label:'Calculadora de pedido', oc_card_hint:'Tocá para armar un pedido',
    ...
    recap_compare_hint:'Tocá dos períodos para compararlos lado a lado',
    ...
    manual_spend_err:'Poné un monto mayor a 0.',
    exit_title:'Antes de que te vayas…',
    exit_offer_title:'Quedate un mes — gratis',
    exit_offer_sub:'Contanos qué te falló y te damos 30 días gratis mientras lo reparamos. Tus datos quedan intactos, y leemos cada respuesta.',
    ...
    exit_reason_ph:'Contanos más (opcional)…', exit_next:'Continuar',
    ...
    exit_delete_btn:'Eliminar mi cuenta', exit_thanks_offer:'¡Gracias por la chance! Estamos en eso — tenés 30 días gratis.',
    inv_layout_label:'Vista del inventario', inv_layout_rows:'Una columna (más grande)',
    inv_layout_cols2:'Dos columnas', inv_layout_cols3:'Tres columnas',
    inv_layout_cols4:'Cuatro columnas',
    inv_tool_order:'Pedido', inv_tool_count:'Conteo', inv_all_chip:'Todos',
    ...
    oc_copied:'Pedido copiado — pegalo en WhatsApp, email o donde quieras',
  ...
  en: {
    ...
    tab_catalog:'Catalog',
    activity_catalog_published:'published the catalog ({n} products)',
    catalog_wa_label:'WhatsApp for orders',
    catalog_photo_fab_aria:'Take a photo for a product',
    catalog_camera_title:'Product photo',
    catalog_camera_sub:'Take or choose the photo; then say which product it is and edit it if you like.',
    catalog_publish_header:'Publishing',
    catalog_auto_updated:'Catalog updated',
    settings_catalog_btn:'📖 Catalog publishing',
    ...
    catalog_tool_collage:'Collage',
    catalog_tool_templates:'Templates',
    tpl_title:'Templates', tpl_sub:'Build a ready-to-share or print image with your products.',
    tpl_kind_grid:'Catalog grid', tpl_kind_list:'Price list', tpl_kind_menu:'Restaurant menu', tpl_kind_offer:'Offer',
    tpl_kind_cats:'By category', tpl_items_n:'{n} products', tpl_gallery_hint:'Tap a design to see it big with your products.',
    tpl_format_post:'Post', tpl_format_story:'Story', tpl_format_sheet:'Sheet',
    tpl_style_dark:'Dark', tpl_style_light:'Light', tpl_style_warm:'Warm',
    tpl_scope_catalog:'Catalog items', tpl_scope_all:'All',
    tpl_page:'Page {i} of {n}', tpl_empty:'No products for the template — mark some in the catalog or choose "All".',
    tpl_share:'Share', tpl_save:'Save', tpl_rendering:'Building the image…', tpl_saved:'Image saved', tpl_shared_fallback:'Image downloaded — share it from your gallery',
    tpl_offer_label:'OFFER', tpl_menu_footer:'Order on WhatsApp', tpl_price_ask:'Ask',
    catalog_collage_min:'Pick 2 to 4 photos for the collage',
    catalog_collage_pick:'Pick a layout',
    catalog_examples_note:'This is how your catalog looks. These examples disappear on their own once you add your products with the 📷 Camera.',
    catalog_collage_photos:'photos',
    catalog_collage_need_n:'This layout needs {n} photos',
    catalog_tool_camera:'Camera',
    catalog_select_btn:'Select',
    catalog_select_done:'Done',
    catalog_select_hint:'Selection mode: tap products to include or remove them from the catalog.',
    catalog_assign_title:'Which product is this photo for?',
    catalog_detecting:'Recognizing the product…',
    catalog_edit_btn:'Edit',
    catalog_edit_title:'Edit photo',
    catalog_edit_auto:'Auto',
    catalog_edit_rotate:'Rotate',
    catalog_edit_zoom:'Zoom',
    catalog_tab_light:'Light',
    catalog_tab_color:'Color',
    catalog_tab_frame:'Frame',
    catalog_edit_temp:'Warmth',
    catalog_edit_shadows:'Shadows',
    catalog_edit_highlights:'Highlights',
    catalog_edit_bright:'Brightness',
    catalog_edit_contrast:'Contrast',
    catalog_edit_sat:'Saturation',
    catalog_edit_sharp:'Sharpness',
    catalog_edit_done:'Done',
    catalog_edit_drag_hint:'Drag the photo to frame it; zoom gets closer.',
    catalog_rembg_btn:'Remove background',
    catalog_rembg_working:'Removing background…',
    catalog_rembg_bg:'Background:',
    catalog_rembg_revert:'Original photo',
    catalog_rembg_done:'Background removed — pick a background color',
    catalog_rembg_error:'Could not remove the background — try again',
    catalog_enhance_btn:'AI Enhance',
    catalog_enhance_working:'Enhancing with AI…',
    catalog_enhance_done:'Photo enhanced with AI',
    catalog_enhance_error:'Could not enhance the photo — try again',
    catalog_stage_btn:'AI Scene',
    catalog_stage_working:'Generating the scene…',
    catalog_stage_hint:'Pick where to place your product — the AI builds the scene with matching light and shadows.',
    catalog_stage_wood:'Wooden table',
    catalog_stage_kitchen:'Kitchen',
    catalog_stage_studio:'Studio',
    catalog_stage_shelf:'Store shelf',
    catalog_stage_custom_ph:'Or describe it: "on grass at sunset"…',
    catalog_stage_go:'Generate',
    catalog_stage_done:'Scene generated',
    catalog_stage_error:'Could not generate the scene — try again',
    ...
    catalog_filter_retro:'Retro',
    catalog_filter_bw:'B&W',
    catalog_recipes_header:'Pieces / recipes',
    catalog_publish_btn:'Publish catalog',
    catalog_update_btn:'Update catalog',
    catalog_publishing:'Publishing…',
    catalog_published_toast:'Catalog published — share the link',
    catalog_copy_btn:'Copy',
    catalog_share_btn:'Share',
    catalog_open_btn:'View',
    catalog_copied_toast:'Link copied',
    catalog_unpublish_btn:'Unpublish',
    catalog_unpublish_confirm:'Unpublish the catalog? The link will stop working until you publish again (same link).',
    catalog_unpublished_toast:'Catalog unpublished — the link no longer works',
    catalog_none_selected:'Check at least one product',
    catalog_error:'Could not publish — check your connection and try again',
    catalog_needs_account_note:'To publish your catalog you need to save your account (so the link stays yours forever).',
    ...
    shelf_price_empty_note:'Without a sale price, this outflow adds no Income to the month recap.',
    ...
    inv_layout_label:'Inventory view', inv_layout_rows:'One column (larger)',
    inv_layout_cols2:'Two columns', inv_layout_cols3:'Three columns',
    inv_layout_cols4:'Four columns',
    inv_tool_order:'Order', inv_tool_count:'Count', inv_all_chip:'All',
