...
const I18N = {
  es: {
    ...
    scan_similar_note:'Se emparejó con «{name}» por parecido — revisá que sea el mismo producto.',
    scan_add_as_new:'Es otro producto — agregarlo aparte',
  ...
  en: {
    ...
    scan_similar_note:'Matched to “{name}” by similarity — make sure it’s the same product.',
    scan_add_as_new:'It’s a different product — add it separately',
