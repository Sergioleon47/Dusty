...
const I18N = {
  es: {
    ...
    ivd_by_category:'Por categoría', ivd_by_product:'Por producto', ivd_products_n:'{n} productos', ivd_tap_hint:'Tocá un producto para editarlo.',
  ...
  en: {
    ...
    ivd_by_category:'By category', ivd_by_product:'By product', ivd_products_n:'{n} products', ivd_tap_hint:'Tap a product to edit it.',
