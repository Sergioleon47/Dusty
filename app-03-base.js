...
const I18N = {
  es: {
    ...
    scan_tap_photo:'Tocá para sacar o elegir una foto', scan_upload_gallery_btn:'o subí una desde la galería',
    photo_src_library:'Fototeca', photo_src_camera:'Tomar foto',
  ...
  en: {
    ...
    scan_tap_photo:'Tap to take or choose a photo', scan_upload_gallery_btn:'or upload one from your gallery',
    photo_src_library:'Photo Library', photo_src_camera:'Take Photo',
