...
const I18N = {
  es: {
    ...
    catalog_photo_fab_aria:'Editar las fotos de tus productos',
    catalog_photo_mode_hint:'Modo fotos: tocá un producto y se abre la cámara para sacarle su foto nueva. Tocá la cámara de arriba de nuevo para salir.',
  ...
  en: {
    ...
    catalog_photo_fab_aria:'Edit your product photos',
    catalog_photo_mode_hint:'Photo mode: tap a product and the camera opens to take its new photo. Tap the camera above again to exit.',
