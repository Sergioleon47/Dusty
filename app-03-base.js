...
const I18N = {
  es: {
    ...
    catalog_photo_mode_hint:'Modo fotos: tocá un producto para cambiarle la foto. Tocá la cámara de nuevo para salir.',
  ...
  en: {
    ...
    catalog_photo_mode_hint:'Photo mode: tap a product to change its photo. Tap the camera again to exit.',
