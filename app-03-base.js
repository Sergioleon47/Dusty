...
const I18N = {
  es: {
    ...
    catalog_camera_sub:'Saca o elige la foto; después le dices de qué producto es y la puedes editar.',
    ...
    tpl_title:'Plantillas', tpl_sub:'Arma una imagen lista para compartir o imprimir con tus productos.',
    tpl_kind_grid:'Catálogo en grilla', tpl_kind_list:'Lista de precios', tpl_kind_menu:'Menú de restaurante', tpl_kind_offer:'Oferta',
    tpl_kind_cats:'Por categorías', tpl_items_n:'{n} productos', tpl_gallery_hint:'Toca un diseño para verlo grande con tus productos.',
    ...
    tpl_page:'Página {i} de {n}', tpl_empty:'No hay productos para la plantilla — marca algunos en el catálogo o elige "Todos".',
    tpl_share:'Compartir', tpl_save:'Guardar', tpl_rendering:'Armando la imagen…', tpl_saved:'Imagen guardada', tpl_shared_fallback:'Imagen descargada — compártela desde tu galería',
    tpl_offer_label:'OFERTA', tpl_menu_footer:'Pedidos por WhatsApp', tpl_price_ask:'Consultar',
    catalog_collage_min:'Elige de 2 a 4 fotos para el collage',
    catalog_collage_pick:'Elige el diseño',
    ...
    catalog_select_hint:'Modo selección: toca los productos para incluirlos o sacarlos del catálogo.',
    ...
    catalog_edit_drag_hint:'Arrastra la foto para encuadrarla; el zoom acerca.',
    ...
    catalog_rembg_done:'Fondo quitado — elige el color de fondo',
    catalog_rembg_error:'No se pudo quitar el fondo — prueba de nuevo',
    catalog_enhance_btn:'Mejorar IA',
    catalog_enhance_working:'Mejorando con IA…',
    catalog_enhance_done:'Foto mejorada con IA',
    catalog_enhance_error:'No se pudo mejorar la foto — prueba de nuevo',
    catalog_stage_btn:'Escenario IA',
    catalog_stage_working:'Generando el escenario…',
    catalog_stage_hint:'Elige dónde poner tu producto — la IA arma el ambiente con su luz y sombras.',
    ...
    catalog_stage_custom_ph:'O descríbelo tú: "sobre pasto, al atardecer"…',
    catalog_stage_go:'Generar',
    catalog_stage_done:'Escenario generado',
    catalog_stage_error:'No se pudo generar el escenario — prueba de nuevo',
    ...
    catalog_share_text:'Mira el catálogo de {biz} y haz tu pedido:',
    catalog_share_text_nobiz:'Mira mi catálogo y haz tu pedido:',
    ...
    catalog_assign_create_hint:'¿No está en la lista? Escribe el nombre y créalo nuevo.',
    catalog_assign_no_match:'Ningún producto coincide',
    catalog_edit_compare_hint:'Mantén presionada la foto para ver el original',
    ...
    catalog_published_toast:'Catálogo publicado — comparte el link',
    ...
    catalog_none_selected:'Marca al menos un producto',
    catalog_error:'No se pudo publicar — revisa tu conexión y prueba de nuevo',
    catalog_needs_account_note:'Para publicar tu catálogo necesitas guardar tu cuenta (así el link queda tuyo para siempre).',
    ...
    inv_selected_n:'{n} seleccionado(s)', inv_select_all:'Todos', inv_select_none:'Ninguno',
    ...
    catalog_quality_hint:'Puedes editarla o sacar otra desde la vista previa.',
    ...
    prod_no_recipes:'Guarda lo que produces como recetas — al registrar una producción, los insumos se descuentan del inventario solos y ves el costo por pieza.',
    ...
    recipe_need_name:'Ponle un nombre a la receta.',
  ...
  en: {
    ...
    inv_selected_n:'{n} selected', inv_select_all:'All', inv_select_none:'None',
