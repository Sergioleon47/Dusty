...
const I18N = {
  es: {
    ...
    catalog_none_published:'Publicá el catálogo primero — el link para compartir está abajo',
  ...
  en: {
    ...
    catalog_none_published:'Publish the catalog first — the share link is below',
