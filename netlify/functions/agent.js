...
const TOOLS = [
  ...
  { name: 'open_screen', description: 'Abre una pantalla de Dusty para que el usuario la vea.',
    input_schema: { type: 'object', properties: { screen: { type: 'string', enum: ['collect', 'jobs', 'equipment', 'inventory', 'receipts', 'budget', 'recap', 'settings', 'services', 'scan', 'item', 'job', 'asset'] }, text: { type: 'string', description: 'Para item/job/asset: el nombre del producto, cliente o equipo a abrir' } }, required: ['screen'] } },
